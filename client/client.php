...
function uc_avatar($uid, $type = 'virtual', $returnhtml = 1) {
	...
	if($returnhtml) {
		return '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="450" height="'.$height.'" id="mycamera" align="middle">
			...
			<embed src="'.$uc_avatarflash.'" quality="high" bgcolor="#ffffff" width="450" height="'.$height.'" name="mycamera" align="middle" allowScriptAccess="always" allowFullScreen="false" scale="exactfit"  wmode="transparent" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
		</object>';
	} else {
		return array(
			'width', '450',
