...
<td id="main">
    <div id="info">
    <div id="avatar"><img alt="01" src="./uc.shenei.net/avatar.php@uid=1&size=middle"/></div>
    <div id="panel">
        <div class="prohead">
            <span class="nickname vip">01</span><span class="at">(@01)</span>
                                                <span class="uofflineico">用户离线</span>
                                        <div class="clearline"></div>
            <p><a href="index.php@s=_2F01">http://t.shenei.net/index.php?s=/01</a></p>
        </div>
        <p class="state">
                        <a href="index.php@s=_2F01">广播 <b>1</b> 条</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="index.php@s=_2F01_2Ffollowing">收听 <b>0</b> 人</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <a href="index.php@s=_2F01_2Ffollower">听众 <b>0</b> 人</a>
        </p>
            </div>
</div>
<div class="clearline"></div>
...
<td id="sidebar" rowspan="2"><div class="contenter">
    <div class="sect first-sect">
        <h2>个人资料</h2>
                        <p class="userurl">介绍：这家伙很懒，什么都没有写！</p>
                <div class="userauth">
            <div class="bg"></div>
            <div class="body">
...
<script type="text/javascript">$("#lookmore").val('public');</script>
