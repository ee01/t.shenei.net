...
class TopicAction extends Action {
    ...
    public function deltopic() {
        ...
        $this->assign('url',SITE_URL.'/admin.php?s=/Topic');
        $this->assign('title','管理删除成功');
    ...
    public function tuijian() {
        ...
        $this->assign('url',SITE_URL.'/admin.php?s=/Topic&order=5');
        $this->assign('title','话题推荐成功');
        $this->assign('position','系统跳转');
        $this->display('Common/return');
    }
