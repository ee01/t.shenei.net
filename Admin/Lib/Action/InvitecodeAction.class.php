...
class InvitecodeAction extends Action {
    ...
    public function delcode() {
        ...
        if (is_array($delcode)) {
            ...
            $this->assign('url',SITE_URL.'/admin.php?s=/Invitecode/index/t/'.$t);
            $this->assign('title','指定的邀请码删除成功了');
            $this->assign('position','系统跳转');
            $this->display('Common/return');
        } else {
            $this->redirect('Invitecode/index/t/'.$t);
        }
    }
    ...
    public function create() {
        ...
        $this->assign('url',SITE_URL.'/admin.php?s=/Invitecode');
        $this->assign('title','邀请码生成成功');
        $this->assign('position','系统跳转');
        $this->display('Common/return');
    }
}
