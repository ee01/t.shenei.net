...
<div class="friends">
<div id="stream">
    <div class="itemtitle"><h1>新手帮助</h1></div>
    <div class="faq">
        <h2>1  如何使用站长微博？</h2><br/>
        <p>可以告诉大家你在做什么，可以随便看看大家都在做什么，也可以关注几个有趣的人。</p>
        <p>对了，别忘了上传头像，让大家看到真实的你哦。</p><br/>
        <h2>2 你可以通过以下方式来使用<?php echo ($site['sitename']); ?>：</h2><br/>
        <p>1、网页，地址是 <a href="<?php echo SITE_URL;?>"><?php echo SITE_URL;?></a></p>
        <p>2、手机上网，地址是 <a href="<?php echo SITE_URL;?>/Wap"><?php echo SITE_URL;?>/Wap</a></p>
        ...
        <h2>4  如何申请用户认证？</h2><br/>
        <p>需要申请认证的用户，请参看<a href="<?php echo SITE_URL;?>/Index/vip">用户认证申请手册</a></p><br/>
        <h2>5  如何举报其他用户？</h2><br/>
