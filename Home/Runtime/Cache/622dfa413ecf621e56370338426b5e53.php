...
<div id="login">
    ...
    <form method="post" action="<?php echo SITE_URL;?>/dologin" class="vf lf" style="margin-top:50px">
    <p>
        <label class="label_input" for="loginname">用户名<?php if(ET_UC!=TRUE){ ?> 或 Email地址<?php }else{ ?> 或 Ucenter帐号<?php } ?></label>
    ...
    <p>
        ...
        <input tabindex="3" type="checkbox" name="rememberMe" id="rememberMe" class="checkbox" value="on" />&nbsp;&nbsp;下次自动登录
        </label>
    </p>
    <p class="act">
        <input tabindex="4" type="submit" class="button1" value="立即登录" />
    </p>
    </form>
</div>
