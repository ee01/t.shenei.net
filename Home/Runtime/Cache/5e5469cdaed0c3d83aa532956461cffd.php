...
<div id="register">
    ...
    <table border="0" style="width:90%;margin-left:40px;margin-bottom:20px">
    <tr><td valign="top">
    <h3 class="tt">欢迎您加入<?php echo ($site[sitename]); ?>，您必须激活帐号才能登陆。</h3>
    <table class="regtb">
        <tr height="50px">
            <th>激活帐号：</th>
            <td width="210px"><?php echo ($activeuser); ?></td>
        </tr>
        <tr height="50px">
            <th>输入密码：</th>
            <td width="210px"><input type="password" name="password" class="input_text"/></td>
        </tr>
        <tr height="50px">
            <td></td>
            <td colspan="1"><input type="hidden" name="activation" value="<?php echo ($activeuser); ?>">
            <input type="hidden" name="auth" value="<?php echo urlencode($auth);?>">
            <input type="submit" class="button1" value="立即激活"/></td>
        </tr>
    </table>
    </td></tr>
    </table>
