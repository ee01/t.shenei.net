...
<style>.bodys {margin:10px auto}</style>
<div class="keywordbox">
    <div class="keys">
        <div class="line"></div>
        <div class="h3">关于我们</div>
        <div class="bodys"><?php echo stripslashes($site['about']);?></div>
    </div>
    <div class="keys">
        <div class="line"></div>
        <div class="h3">联系我们</div>
        <div class="bodys"><?php echo stripslashes($site['contect']);?></div>
    </div>
    <div class="keys">
        <div class="line"></div>
        <div class="h3">加入我们</div>
        <div class="bodys"><?php echo stripslashes($site['join']);?></div>
    </div>
</div>
