    ...
    * */
    static public function water($groundImage,$waterPos=0,$waterImage="",$waterText="", $textFont=5) {
        ...
        if($isWaterImage) { //图片水印
            ...
            $temp = imagettfbbox(ceil($textFont*2.5),0,"./Public/images/simhei.ttf",$waterText);
            $w = $temp[2] - $temp[6];
            $h = $temp[3] - $temp[7];
            unset($temp);
        }
        ...
        if($isWaterImage) { //图片水印
            ...
            imagettftext($ground_im, ceil($textFont*2.5), 0 , $posX, $posY,imagecolorallocate($ground_im, $R1, $G1, $B1),"./Public/images/simhei.ttf",$waterText);
            imagettftext($ground_im, ceil($textFont*2.5), 0 , $posX-2, $posY-2,imagecolorallocate($ground_im, $R2, $G2, $B2),"./Public/images/simhei.ttf",$waterText);
        }
